...
//		level = new BaseLevel("Scratch",1600,1600);
		...
		player = new BasicShip(1, new Image("assets/images/ships/nasa/mercury/mercury.png"));
		gun = new BasicGun(1);
		...
		dude = new BasicShip(2, new Image("assets/images/ships/nasa/mercury/mercury.png"));
